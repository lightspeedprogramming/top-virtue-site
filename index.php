	        					...
	        					<div class="row">
	        						<div class="col-12">
				        				<div class="slider-content-inner">
				        					<h2 class="slide-title">Top Virtual Employee</h2>
				        					<p>We here at Top Virtual Employee provide you the best internet based services that can provide your business a huge hike which can turn out to be highly profitable for your business.</p>
				        					<div class="sider-btn">
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					<div class="about-details lg-md-0">
						...
						<!--
						<h4 class="about-sub-title">Why Choose Us?</h4>
						<ul class="about-list">
							<li><i class="fa fa-check-circle"></i>Amco laboris nisi ut aliquip xea commodo consequt.</li>
							<li><i class="fa fa-check-circle"></i>Pellentesque in ipsum id orci porta dapibus.</li>
							<li><i class="fa fa-check-circle"></i>Vivamus suscipit tortor eget felis porttitor volutpat.</li>
							<li><i class="fa fa-check-circle"></i>Sed lectus nibh. Donec rutrum congue eget malesuada.</li>
							<li><i class="fa fa-check-circle"></i>Mauris blandit elit, eget  nibh pulvinar Quisque velit</li>
						</ul>
						-->
					</div>
				</div>
				...
				<div class="masonry-wrapper w-100 gutter-bottom-30">
					...
					<div class="masonry-item col-lg-4 col-md-6">
						<article class="blog-post">
							...
							<div class="blog-post-des">
								<div class="blog-post-thumb-circle">
									<div class="container">
										<div class="row">
							...
							<div class="blog-post-des">
								<div class="blog-post-thumb-circle">
									<div class="container">
										<div class="row">
											<div class="col-md-12 text-center">
												<img src="assets/images/data-entry/img-1.png" alt="">
											</div>
										</div>
									</div>
							...
							<div class="blog-post-des">
								<div class="blog-post-thumb-circle">
									<div class="container">
										<div class="row">
											<div class="col-md-12 text-center">
												<img src="assets/images/internet-marketing/img-1.png">
											</div>
										</div>
									</div>
							...
							<div class="blog-post-des">
								<div class="blog-post-thumb-circle">
									<div class="container">
										<div class="row">
											<div class="col-md-12 text-center">
												<img src="assets/images/it-outsourcing/img-1.png">
											</div>
										</div>
									</div>
